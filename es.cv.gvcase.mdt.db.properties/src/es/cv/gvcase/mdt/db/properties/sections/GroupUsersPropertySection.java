...
public class GroupUsersPropertySection extends AbstractCollectionPropertySection {

	@Override
	protected EStructuralFeature getFeature() {

		return SQLAccessControlPackage.eINSTANCE.getGroup_User();
	}
	...
	protected EList<EObject> getCandidateElements() {
		...
		if(selectedObject != null) {
			...
			for(AuthorizationIdentifier aid : db.getAuthorizationIds()) {
				if(aid instanceof User) users.add((User)aid);
			}
