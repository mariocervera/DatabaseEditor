...
public class OnUpdatePropertySection extends AbstractChooserPropertySection {
	...
	protected EStructuralFeature getFeature() {
		return SQLConstraintsPackage.eINSTANCE.getForeignKey_OnUpdate();
	}
	...
	protected Object getFeatureValue() {
		...
		if(object instanceof ForeignKey) {
			 return ((ForeignKey)object).getOnUpdate();
		}
