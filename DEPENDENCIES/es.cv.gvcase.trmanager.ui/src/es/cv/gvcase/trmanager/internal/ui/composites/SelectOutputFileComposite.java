...
public class SelectOutputFileComposite extends SelectNewResourceComposite {

	
	public SelectOutputFileComposite(Composite parent, int style,
	...
	protected SelectionListener getSelectionListener(Button button,  Text valueText, TransformedRes resource){
		return new ButtonFileSelectionListener(button, new LoadFolderDialog(getShell(), getInputResource()), valueText);	
	}
	...
	private class ButtonFileSelectionListener implements SelectionListener {
		...
		ButtonFileSelectionListener(Button browseButton, LoadFolderDialog dialog, Text textField) {
