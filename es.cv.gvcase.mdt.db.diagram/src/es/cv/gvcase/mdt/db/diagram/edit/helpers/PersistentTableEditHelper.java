...
/**
 * Will configure a newly created {@link PersistentTable} to have its Generated AdditionalAttribute to false.
 * 
 * @generated
 */
public class PersistentTableEditHelper extends SqlmodelBaseEditHelper {
	...
	protected ICommand getConfigureCommand(ConfigureRequest req) {
		...
		if (elementToConfigure instanceof PersistentTable && domain != null) {
			// every newly created PersistentTable must have its Generated
			// Property from AdditionalAttributes set to false.
			final PersistentTable table = (PersistentTable) elementToConfigure;
			AbstractTransactionalCommand command = new AbstractTransactionalCommand(
					domain, "Configure PersistentTable", null) {
