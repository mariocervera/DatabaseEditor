 ...
 * @generated
 */
public class PersistentTableCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersistentTableCreateCommand(CreateElementRequest req,
			EObject eObject) {
	 ...
	 * @generated
	 */
	public static PersistentTableCreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new PersistentTableCreateCommand(req, eObject);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		PersistentTable newElement = SQLTablesFactory.eINSTANCE
				.createPersistentTable();

		Schema owner = (Schema) getElementToEdit();
		owner.getTables().add(newElement);

		SqlmodelElementTypes.init_PersistentTable_1001(newElement);
	...
	/**
	 * @generated NOT ; modified to add the AdditionalAttribute Generated via EAnnotations
	 */
	protected void doConfigure(PersistentTable newElement,
