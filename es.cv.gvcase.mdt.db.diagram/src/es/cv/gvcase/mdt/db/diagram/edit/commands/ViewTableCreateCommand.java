 ...
 * @generated
 */
public class ViewTableCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ViewTableCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static ViewTableCreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new ViewTableCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public ViewTableCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ViewTable newElement = SQLTablesFactory.eINSTANCE.createViewTable();

		Schema owner = (Schema) getElementToEdit();
		owner.getTables().add(newElement);

		SqlmodelElementTypes.init_ViewTable_1002(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ViewTable newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
