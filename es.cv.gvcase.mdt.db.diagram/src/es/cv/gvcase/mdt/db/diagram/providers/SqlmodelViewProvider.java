 ...
 * @generated
 */
public class SqlmodelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SqlmodelVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = SqlmodelVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SqlmodelElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != SqlmodelVisualIDRegistry
		...
		return PersistentTableEditPart.VISUAL_ID == visualID
				|| ViewTableEditPart.VISUAL_ID == visualID
				|| ColumnEditPart.VISUAL_ID == visualID
				|| Column2EditPart.VISUAL_ID == visualID
				|| PersistentTable2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SqlmodelVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SqlmodelVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = SqlmodelVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = SqlmodelVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case PersistentTableEditPart.VISUAL_ID:
			return createPersistentTable_1001(domainElement, containerView,
					index, persisted, preferencesHint);
		case ViewTableEditPart.VISUAL_ID:
			return createViewTable_1002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ColumnEditPart.VISUAL_ID:
			return createColumn_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case Column2EditPart.VISUAL_ID:
			return createColumn_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case PersistentTable2EditPart.VISUAL_ID:
			return createPersistentTable_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SqlmodelVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ForeignKeyEditPart.VISUAL_ID:
			return createForeignKey_3001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ViewTableViewedTables2EditPart.VISUAL_ID:
			return createViewTableViewedTables_3002(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createPersistentTable_1001(EObject domainElement,
		...
		Color color = PersistentTableEditPart.getDeclaredBackgroundColor();
		...
		lineStyle.setLineColor(FigureUtilities
				.RGBToInteger(new org.eclipse.swt.graphics.RGB(0, 0, 0)));
		node.getStyles().add(lineStyle);

		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SqlmodelVisualIDRegistry
		...
		Node label4001 = createLabel(node, SqlmodelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createViewTable_1002(EObject domainElement, View containerView,
		...
		Node label4002 = createLabel(node, SqlmodelVisualIDRegistry
				.getType(ViewTableNameEditPart.VISUAL_ID));
		createCompartment(node, SqlmodelVisualIDRegistry
				.getType(ViewTableViewedColumnsEditPart.VISUAL_ID), false,
				false, true, true);
		createCompartment(node, SqlmodelVisualIDRegistry
				.getType(ViewTableViewedTablesEditPart.VISUAL_ID), false,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createColumn_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
				.setType(SqlmodelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createColumn_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SqlmodelVisualIDRegistry
				.getType(Column2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createPersistentTable_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Edge createForeignKey_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(SqlmodelVisualIDRegistry
		...
		Node label4003 = createLabel(edge, SqlmodelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createViewTableViewedTables_3002(View containerView, int index,
