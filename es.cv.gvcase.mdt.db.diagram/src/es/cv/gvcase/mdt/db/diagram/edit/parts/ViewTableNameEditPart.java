 ...
 * @generated
 */
public class ViewTableNameEditPart extends
	 ...
	 * @generated
	 */
	public ViewTableNameEditPart(View view) {
		super(view);
	}
			...
			parser = SqlmodelParserProvider
					.getParser(
							...
							SqlmodelVisualIDRegistry
									.getType(es.cv.gvcase.mdt.db.diagram.edit.parts.ViewTableNameEditPart.VISUAL_ID));
