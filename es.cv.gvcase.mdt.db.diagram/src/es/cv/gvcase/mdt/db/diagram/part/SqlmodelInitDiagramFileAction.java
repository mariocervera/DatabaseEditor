 ...
 * @generated
 */
public class SqlmodelInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SqlmodelNewDiagramFileWizard(action.getId(),
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SchemaEditPart.MODEL_ID));
		SqlmodelDiagramEditorUtil.runWizard(getShell(), wizard,
