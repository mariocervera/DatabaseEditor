 ...
 * @generated
 */
public abstract class SqlmodelAbstractExpression {
	 ...
	 * @generated
	 */
	protected SqlmodelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SqlmodelDiagramEditorPlugin.ID;
