 ...
 * @generated
 */
public class PersistentTableNameEditPart extends
	 ...
	 * @generated
	 */
	public PersistentTableNameEditPart(View view) {
		super(view);
	}
			...
			parser = SqlmodelParserProvider
					.getParser(
							...
							SqlmodelVisualIDRegistry
									.getType(es.cv.gvcase.mdt.db.diagram.edit.parts.PersistentTableNameEditPart.VISUAL_ID));
