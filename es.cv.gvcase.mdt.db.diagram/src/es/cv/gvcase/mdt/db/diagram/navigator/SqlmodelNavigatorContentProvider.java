 ...
 * @generated
 */
public class SqlmodelNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public SqlmodelNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), SchemaEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof SqlmodelNavigatorGroup) {
			SqlmodelNavigatorGroup group = (SqlmodelNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof SqlmodelNavigatorItem) {
			SqlmodelNavigatorItem navigatorItem = (SqlmodelNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SchemaEditPart.VISUAL_ID: {
			...
			SqlmodelNavigatorGroup links = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_Schema_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), SqlmodelVisualIDRegistry
					.getType(PersistentTableEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					SqlmodelVisualIDRegistry
							.getType(ViewTableEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(view),
					SqlmodelVisualIDRegistry
							.getType(ViewTableViewedTables2EditPart.VISUAL_ID));
			links
					.addChildren(createNavigatorItems(connectedViews, links,
							false));
			if (!links.isEmpty()) {
		...
		case PersistentTableEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SqlmodelNavigatorGroup incominglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_PersistentTable_1001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SqlmodelNavigatorGroup outgoinglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_PersistentTable_1001_outgoinglinks,
			...
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), SqlmodelVisualIDRegistry
							.getType(ForeignKeyEditPart.VISUAL_ID));
		...
		case ViewTableEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SqlmodelNavigatorGroup incominglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ViewTable_1002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SqlmodelNavigatorGroup outgoinglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ViewTable_1002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), SqlmodelVisualIDRegistry
		...
		case PersistentTable2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SqlmodelNavigatorGroup incominglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_PersistentTable_2003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SqlmodelNavigatorGroup outgoinglinks = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_PersistentTable_2003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
		...
		case ForeignKeyEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SqlmodelNavigatorGroup target = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ForeignKey_3001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SqlmodelNavigatorGroup source = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ForeignKey_3001_source,
		...
		case ViewTableViewedTables2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			SqlmodelNavigatorGroup target = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ViewTableViewedTables_3002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			SqlmodelNavigatorGroup source = new SqlmodelNavigatorGroup(
					Messages.NavigatorGroupName_ViewTableViewedTables_3002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), SqlmodelVisualIDRegistry
					.getType(PersistentTableEditPart.VISUAL_ID));
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new SqlmodelNavigatorItem((View) it.next(), parent,
					isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof SqlmodelAbstractNavigatorItem) {
			SqlmodelAbstractNavigatorItem abstractNavigatorItem = (SqlmodelAbstractNavigatorItem) element;
