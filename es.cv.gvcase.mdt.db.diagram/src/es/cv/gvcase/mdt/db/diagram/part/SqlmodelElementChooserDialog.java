 ...
 * @generated
 */
public class SqlmodelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public SqlmodelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.SqlmodelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "sqlschema".equals(fileExtension); //$NON-NLS-1$
	}
