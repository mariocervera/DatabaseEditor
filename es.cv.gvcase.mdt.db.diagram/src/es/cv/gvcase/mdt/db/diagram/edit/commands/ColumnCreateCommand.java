...
public class ColumnCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ColumnCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static ColumnCreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new ColumnCreateCommand(req, eObject);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SqlmodelElementTypes.init_Column_2001(newElement);
