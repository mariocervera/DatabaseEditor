 ...
 * @generated
 */
public class SqlmodelStructuralFeatureParser extends SqlmodelAbstractParser {
	 ...
	 * @generated
	 */
	public SqlmodelStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(SqlmodelDiagramEditorPlugin.ID,
