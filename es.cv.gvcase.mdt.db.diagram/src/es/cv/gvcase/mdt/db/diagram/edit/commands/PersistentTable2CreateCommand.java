 ...
 * @generated
 */
public class PersistentTable2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersistentTable2CreateCommand(CreateElementRequest req,
			EObject eObject) {
	 ...
	 * @generated
	 */
	public static PersistentTable2CreateCommand create(
			CreateElementRequest req, EObject eObject) {
		return new PersistentTable2CreateCommand(req, eObject);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ViewTable childHolder = (ViewTable) getElementToEdit();
		childHolder.getViewedTables().add(newElement);
