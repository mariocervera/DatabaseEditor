 ...
 * @generated
 */
public class ForeignKeyNameEditPart extends
		es.cv.gvcase.mdt.common.diagram.editparts.LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SqlmodelVisualIDRegistry
						.getType(es.cv.gvcase.mdt.db.diagram.edit.parts.ForeignKeyNameEditPart.VISUAL_ID),
				new Point(1, -15));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SqlmodelTextSelectionEditPolicy());
