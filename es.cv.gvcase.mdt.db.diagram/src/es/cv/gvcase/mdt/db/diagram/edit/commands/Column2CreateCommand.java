...
public class Column2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Column2CreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static Column2CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Column2CreateCommand(req, eObject);
	}
